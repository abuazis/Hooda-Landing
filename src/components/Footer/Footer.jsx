            ...
            <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                ...
                <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                    <a href="/#" class="flex title-font font-medium items-center md:justify-start justify-center ">
                       <HoodaLogo width={180} height={180} />
                    </a>
                ...
                <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <li>
                            <a href="/#" class=" hover:text-gray-800">First Link</a>
                        </li>
                        <li>
                            <a href="/#" class=" hover:text-gray-800">Second Link</a>
                        </li>
                        <li>
                            <a href="/#" class=" hover:text-gray-800">Third Link</a>
                        </li>
                        <li>
                            <a href="/#" class=" hover:text-gray-800">Fourth Link</a>
                        </li>
                        </nav>
                    </div>
                    <div class="lg:w-1/4 md:w-1/2 w-full px-4">
